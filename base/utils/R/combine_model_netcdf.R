...
#' @param start.date date or character in YYYY-MM-DD format: start date of the requested time window.
#' @param end.date date or character in YYYY-MM-DD format: end date of the requested time window.
