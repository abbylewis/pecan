...
- `revision` -- A unique identifier for the model version of `binary`. Format is model-specific, but many models expect a numeric version (eg "2.12.3") and rely on numeric comparisons to match PEcAn configuration behavior to model capabilities.
