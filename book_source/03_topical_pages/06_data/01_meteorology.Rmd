...
- **Site-level analyses** should use flux tower–based datasets (e.g. Ameriflux, Fluxnet, ICOS) when available.
- **Regional analyses** commonly use reanalysis products such as NARR or NLDAS.
- **Global or long-term analyses** typically rely on products like CRUNCEP, ERA5, or GLDAS.
